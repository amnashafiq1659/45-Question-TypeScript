...
let currentUsers = ["Yousuf", "Owais", "Bilal", "Ahsan", "Abdullah"];
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let newUsers = ["Salman", "Subhan", "Yousuf", "Hamdan", "Abdullah"];
...
for (let new_user of newUsers) {
    if (currentUsers.some((current_user) => current_user.toLowerCase() === new_user.toLowerCase()))
